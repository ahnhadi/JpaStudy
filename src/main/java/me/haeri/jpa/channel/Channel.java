...
import me.haeri.jpa.thread.Thread;
import me.haeri.jpa.user.User;
import me.haeri.jpa.userChannel.UserChannel;
...
public class Channel {
    ...
    // EnumType.ORDINARY로 저장 시, Type 내부 정보가 0,1,2...로 저장되어서 나중에 db에서 파악하기 힘들어지므로 실무에서는 사용하지 않음
     ...
     */
    // set, linkedHashSet -> 들어온 순서대로 저장하는게 보장 됨
